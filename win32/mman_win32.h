...
inline static int __map_mman_error(const DWORD err, const int deferr)
{
    if (err == 0)
        return 0;
    //TODO: implement
...
inline static DWORD __map_mmap_prot_page(const int prot)
{
    DWORD protect = 0;
...
inline static DWORD __map_mmap_prot_file(const int prot)
{
